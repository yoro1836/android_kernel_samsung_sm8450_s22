...
struct cam_ois_cal_addr
{
	uint8_t x_write_addr;
	uint8_t x_read_addr;
	uint8_t y_write_addr;
	uint8_t y_read_addr;
};

struct cam_ois_cal_buf
{
	uint8_t rx_buf[32];
	uint8_t tx_buf[32];
	int16_t ideal_pCal[2];
	int16_t ideal_nCal[2];
	int16_t current_pCal[2];
	int16_t current_nCal[2];
