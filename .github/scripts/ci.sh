...
prepare_env() {
    ...
    sudo apt-get update
    sudo apt-get install -y build-essential bc bison flex libssl-dev make libncurses5-dev git curl clang lld libelf-dev erofs-utils unzip device-tree-compiler
}
